...
export async function typescript(
  ...
  return [
    ...
    {
      files: ['**/*.d.ts'],
      name: 'merlin:typescript:dts-overrides',
      rules: {
    ...
    },
    {
      ...
      name: 'merlin:typescript:tests-overrides',
      rules: {
    ...
    {
      files: ['**/*.js', '**/*.cjs'],
      name: 'merlin:typescript:javascript-overrides',
      rules: {
